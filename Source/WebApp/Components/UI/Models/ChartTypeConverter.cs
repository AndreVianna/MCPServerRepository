...
public static class ChartTypeConverter {
    ...
    public static ChartType FromMudBlazor(MudBlazor.ChartType mudBlazorType) => mudBlazorType switch {
    ...
    public static MudBlazor.ChartType ToMudBlazor(ChartType customType) => customType switch {
