...
/// </summary>
public class IndexServerCommandConsumer : BaseMessageConsumer<IndexServerCommand>
{
    private readonly IMessagePublisher _messagePublisher;
    private readonly ILogger<IndexServerCommandConsumer> _logger;

    public IndexServerCommandConsumer(
