...
public class ApiStepDefinitions(TestContainerFixture fixture, SolutionScenarioContext scenarioContext) {
    ...
    public async Task GivenThereArePackagesInTheFollowingCategories(Table table) {
        ...
        foreach (var row in table.Rows) {
            ...
            for (var i = 0; i < count; i++) {
                ...
                package.Tags = new List<string> { category };
    ...
    private static TrustTier ParseTrustTier(string trustTierText) => trustTierText.ToLowerInvariant() switch {
