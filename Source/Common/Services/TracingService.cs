...
public class TracingService(ILogger<TracingService> logger) : ITracingService {
    private readonly ILogger<TracingService> _logger = logger;
    ...
    public void SetStatus(Activity? activity, ActivityStatusCode statusCode, string? description = null) => activity?.SetStatus(statusCode, description);
    ...
    private class TracingScope(Activity? activity, ILogger logger) : IDisposable {
...
public static class TracingExtensions {
    ...
    private class TracingScope(Activity? activity) : IDisposable {
        private readonly Activity? _activity = activity;
