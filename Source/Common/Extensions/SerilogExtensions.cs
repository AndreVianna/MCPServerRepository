...
public static class SerilogExtensions {
    ...
    /// </summary>
    public static IHostBuilder UseSerilogLogging(this IHostBuilder hostBuilder) => hostBuilder.UseSerilog((context, services, configuration) => {
...
public static class LoggerExtensions {
    ...
    /// </summary>
    public static IDisposable BeginOperation(this MsLogger logger, string operationName, params object[] args) => new OperationLogger(logger, operationName, args);
