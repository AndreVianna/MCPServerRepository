...
public class ContentScanner : IStaticAnalyzer {
    ...
    public Task<SecurityAnalysisResult> AnalyzeAsync(
        ...
        CancellationToken cancellationToken = default) => throw new NotImplementedException("Package content analysis logic will be implemented when first consumer requires it");
    ...
    public Task<SecurityAnalysisResult> AnalyzeFileAsync(
        string filePath,
        Dictionary<string, object>? options = null,
        CancellationToken cancellationToken = default) => throw new NotImplementedException("Package file analysis logic will be implemented when first consumer requires it");
