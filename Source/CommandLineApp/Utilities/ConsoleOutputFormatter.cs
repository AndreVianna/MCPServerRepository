...
public class ConsoleOutputFormatter : IOutputFormatter
{
    ...
    private void WriteTablePackageList(PackageListResponse packages)
    {
        WriteTableSearchResults(new SearchResultResponse
        {
    ...
    private void WriteDetailedPackageList(PackageListResponse packages)
    {
        WriteDetailedSearchResults(new SearchResultResponse
        {
            Packages = packages.Packages,
            TotalCount = packages.TotalCount,
            Page = packages.Page,
