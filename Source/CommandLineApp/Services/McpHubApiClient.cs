...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private static string GetHeaderValue(HttpResponseMessage response, string headerName, string defaultValue) => response.Headers.TryGetValues(headerName, out var values)
