...
- Simple formatting and style checks
...
#### Team Integration
```bash
# Add as git submodule for team sharing
cd .claude
git submodule add https://github.com/yourteam/shared-agents.git shared
ln -s shared/*.md agents/
```
