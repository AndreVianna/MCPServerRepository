...
public class RequestMonitoringMiddleware(
    ...
    private readonly ILogger<RequestMonitoringMiddleware> _logger = logger;
...
public static class RequestMonitoringExtensions {
    ...
    /// </summary>
    public static IApplicationBuilder UseRequestMonitoring(this IApplicationBuilder builder) => builder.UseMiddleware<RequestMonitoringMiddleware>();
}